...
export default function Scene({
  ...
  console.log(materials['Material.023'])
  ...
  return (
    <>
      ...
      <mesh geometry={nodes.Cylinder.geometry} material={materials['Material.023']} position={[3.476, 4.855, -9.292]} rotation={[0, 0.537, 0]} ref={crederaBottle} onClick={onCrederaCubeClick}
