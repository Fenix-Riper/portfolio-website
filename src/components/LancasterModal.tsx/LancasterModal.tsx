...
export default function CrederaModal() {
  return (
    <div className="relative top-1/2 left-1/2 w-[95vw] h-[95vh] bg-gray-200 bg-opacity-70 -translate-x-1/2 -translate-y-1/2 rounded-lg z-10 overflow-y-auto overflow-x-auto">
      ...
      <div className="pt-5 pb-40 w-full bg-lancaster-red bg-opacity-70">
