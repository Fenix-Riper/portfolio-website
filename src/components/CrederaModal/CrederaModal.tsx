      ...
      <div className="w-full">
        ...
        <div className="mt-72 w-full text-center flex justify-center">
          <h1 className="text-credera-grey text-5xl font-serif w-7/12">
            ...
            <span className="text-credera-white">software engineer</span> is
            like setting sail in an endless sea of innovation, where every line
            of code is a <span className="text-credera-white">new horizon</span>
        ...
        />
        <div className="pt-5 pb-40 w-full bg-orange-500 bg-opacity-70">
          <h2 className="ml-16 text-credera-grey text-6xl font-serif w-1/2">
            My first steps
          </h2>
          <p className="text-credera-grey text-4xl font-Roboto w-3/4 mt-16 ml-16">
        ...
        {/* <img src={waveDividerOne} className="w-full opacity-70" /> */}
        <div className="w-full text-end flex flex-col items-end bg-orange-500 bg-opacity-70">
          <h2 className="mr-16 text-credera-grey text-6xl font-serif w-1/2">
            The graduate programe
          </h2>
          <p className="text-credera-grey text-4xl font-Roboto w-3/4 mt-16 mr-16">
